...
function TictaeToe() {
  ...
  const toggle = (e,num) =>{
    ...
    if(count%2==0){
      e.target.style.backgroundImage = `url(${crossIcon})`;
      data[num] = "x";
      setCount(count +1);
    }
    else{
      e.target.style.backgroundImage = `url(${circleIcon})`;
      data[num] = "o";
      setCount(count +1);
    }
    checkWin()
  ...
  const won =(winner) => {
    ...
    if (winner === "x") {
      ...
      title.innerHTML = `Congratulations :<img src="${crossIcon}"  alt="cross" /> Wins`;
    } else {
      const title = document.querySelector('.title');
      title.innerHTML = `Congratulations : <img src="${circleIcon}" alt="circle" /> Wins`;
    }
  }
  ...
  const reset = () => {
    ...
    data = [" "," "," "," "," "," "," "," "," "];
    const title = document.querySelector('.title');
    title.innerHTML = 'Tic Tac Toe <span>React<span/>';
  ...
  return (
    <div className='container'>
      <h1 className='title'>Tic Tae Toe Game In <span>React</span></h1>
      <div className="board">
        <div className="row1">
